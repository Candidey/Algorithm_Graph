def dijkstra(graph,src):
    ...
    while nodes:
        ...
        for v in visited:
            for n in nodes:
                instant_distance = graph[src][v] + graph[v][n]
                if instant_distance < min_distance:
                    min_distance = instant_distance
                    graph[src][n] = instant_distance
                    k = n
                    pre = v
        distance[k] = min_distance
